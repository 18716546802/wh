...
%>  
				...
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:22px;line-height:50px;">提醒管理</small>
						</li>
					<li  style="font-size:22px;color:#438eb9;" class="active" id="companyName"></li>
		...
		<!-- 企业提醒 -->
 		<script src="<%=path%>/resources/js/companyAdminRemind.js"></script>
