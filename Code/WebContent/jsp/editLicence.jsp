...
%>  
		...
		<link href="<%=path%>/resources/assets/css/bootstrap-datepicker.standalone.min.css" rel="stylesheet">
			...
			<div class="title"    style=" "  >
				<ul class="breadcrumb"   style="height:50px;">
					...
					<li class="active" style="font-size:22px;color:#438eb9;">修改企业证照</li>
							...
							<div class="row">
								<div class="col-xs-12">
							 		<form  action="" method="post" runat="server" style="height: 500px;"> 
										...
										<tbody>
											<tr class="commonStyle"  >
												<td style="  width: 25%;background: white; "><span style="color: red">*</span>证照名称</td>
												<td  style="background: white;"><input type="text" style="width: 80%;" id="f0502"></td>
											</tr>
											<tr class="commonStyle">
												<td style="background: white;">证照编号</td>
												<td style="background: white;"><input type="text" style="width: 80%;" id="f0503"></td>

											</tr>
											<tr class="commonStyle">
												<td style="background: white;"><span style="color: red">*</span>有效日期</td>
												<td style="background: white;"><input type="text" value="yyyy-mm-dd" id="f0504"></td>	 
											</tr>
											<tr class="commonStyle">
												<td style="background: white;"><span style="color: red">*</span>证照是否有效</td>
												<td style="background: white;">
												<select style="width: 80%;padding-left: 35%;" id="f0505">
							 		...
							 		<div style="height: 100px;padding-top:50px;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitEditLicence">提交</button>
		...
		<!-- 修改证照-->
		<script src="<%=path%>/resources/js/editLicence.js"></script>
		<script src="https://cdn.bootcss.com/bootstrap-datepicker/1.7.1/js/bootstrap-datepicker.min.js"></script>
		<script src="https://cdn.bootcss.com/bootstrap-datepicker/1.7.1/locales/bootstrap-datepicker.zh-CN.min.js"></script>
