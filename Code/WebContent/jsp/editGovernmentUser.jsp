...
<%-- 		<base href="<%=basePath%>"></base> --%>
	...
	<body > 
				...
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:22px;line-height:50px;">政府用户列表</small>
						</li>
					<li class="active" style="font-size:22px;color:#438eb9;">修改政府用户</li>
							...
							<div class="row">
								<div class="col-xs-12">
							 		<form  action="" method="post" runat="server"> 
										<table id="editGovernmentTable" class="table table-striped table-bordered table-hover">									
											<tbody>
							 		...
							 		<div style="height: 50px;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitFormGovernmentUser">提交</button>
		...
		<!-- common js -->
		<script src="<%=path%>/resources/js/editGovernmentUser.js"></script>
