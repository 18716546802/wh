				...
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:22px;line-height:50px;"
							> 地区列表</small>
						</li>
					<li class="active" style="font-size:22px;color:#438eb9;">地区基本信息</li>
...
-->
		...
		<style>
			#jqgh_grid-table_f0602,#jqgh_grid-table_f0603,#jqgh_grid-table_f0604,#jqgh_grid-table_f0206,#jqgh_grid-table_f0207,
			#jqgh_grid-table_f0208,#jqgh_grid-table_f0205{
				text-align: center;
			}
		</style>
		<script src="<%=path%>/resources/js/regionAdd.js"></script>
