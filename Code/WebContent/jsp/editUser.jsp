...
<%-- 		<base href="<%=basePath%>"></base> --%>
	...
	%> --%>
		...
		function slet(){
			if(document.getElementById('f0206').checked=true){
			document.getElementById('f0206').value="是";	
			}
			else if(document.getElementById('f0206').checked=false){
				document.getElementById('f0206').value="否";	
			}
		}
	</script>
    	...
    	<div class="main-content">
			<div class="title"    >
				<ul class="breadcrumb"   style="height:50px;">
					...
					<li class="active" style="font-size:22px;color:#438eb9;">修改万汇用户</li>
										...
										<table id="editUserTable" class="table table-striped table-bordered table-hover">									
											<tbody>
												...
												<tr class="commonStyle">
													...
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0205"></td>
		...
		<script src="<%=path%>/resources/js/editUser.js"></script>
