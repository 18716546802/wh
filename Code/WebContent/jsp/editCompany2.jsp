...
%>  
						...
						<div class="col-xs-12" style="margin-left: -12px;">
							...
							<div class="row">
								<div class="col-xs-12">
							 		<form  action="" method="post" runat="server" style="height: 500px;"> 
										<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tr class="commonStyle"  >
													<td style="background: white"><span style="color: red">*</span>企业名称</td>
													<td style="background: white;"><input style="width: 80%;" type="text" id="f0102"></td>
													<td style="background: white;"><span style="color: red">*</span>企业安全等级</td>
							 		...
							 		<div  >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitEidtCompany">提交</button>
		...
		<!-- 修改公司-->
		<script src="<%=path%>/resources/js/editCompany2.js"></script>
