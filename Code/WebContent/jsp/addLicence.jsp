...
%>  
		...
		<link rel="stylesheet" href="<%=path%>/resources/css/common.css" />
			...
			<div class="title"    style=" "  >
				<ul class="breadcrumb" style="height:50px;"> 
					...
					<li class="active" style="font-size:22px;color:#438eb9;">添加证照</li>
							...
							<div class="row">
								<div class="col-xs-12">
							 		...
							 		<div style="height: 100px;padding-top:50px;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitAddLicence">提交</button>
		...
		<!-- 添加证照-->
		<script src="<%=path%>/resources/js/addLicence.js"></script>
