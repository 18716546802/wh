...
<%-- 		<base href="<%=basePath%>"></base> --%>
	...
	<body > 
    	...
    	<div class="main-content">
			<div class="title"    >
				<ul class="breadcrumb" style="height:50px;">
					...
					<li class="active"  style="font-size:22px;color:#438eb9;">添加地区</li>
							...
							<div class="row">
								<div class="col-xs-12">
										...
										<table id="addCompanyTable" class="table table-striped table-bordered table-hover">									
											<tbody style="background: 100%;">
												...
												<tr class="commonStyle">
													<td style="background: white;width: 25%;"><span style="color:red">*</span>选择类型</td>
													<td style="background: white;">
														<input type="radio" style="width: 10%;" name="file_type" id="file_type1" value="1" checked>一级节点
														<input type="radio" style="width:10%;" name="file_type" id="file_type2" value="2">二级节点
													</td>											 
												</tr>
												...
												<tr class="commonStyle" id="selectRegion">
													<td style="background: white;width: 25%;"><span style="color:red">*</span>请选择上级地区</td>
													<td style="background: white;">
													<select name="regionTree" class="easyui-combotree" data-options="url:'/WH/user/userTree?type=2',method:'GET',required:true" style="width:80%;"></select>													
													</td>													
												</tr>
							 		...
							 		<div style="height: 50px; display: block;text-align: center;margin: auto;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitFormAddRegion" >提交</button>
   									</div>
							 	</form> 
							</div>
		...
		<script src="<%=path%>/resources/js/addRegion.js"></script>
