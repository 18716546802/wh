...
%>  
				...
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:22px;line-height:50px;">隐患管理</small>
						</li>
					<li class="active" style="font-size:22px;color:#438eb9;">今日新隐患</li>
		...
		<!-- 企业基今日隐患-->
		<script src="<%=path%>/resources/js/companyTodayHideDanger.js"></script>
