...
%>  
		...
		<link rel="stylesheet" href="<%=path%>/resources/css/common.css" />
			...
			<div class="title"    style=" "  >
				<ul class="breadcrumb" style="height:50px;">
					...
					<li class="active" style="font-size:22px;color:#438eb9;">添加特种设备</li>
						...
						<div class="col-xs-12" style="margin-left: -12px;">
							...
							<div class="row">
								<div class="col-xs-12">
							 		<form  action="" method="post" runat="server" style="height: 500px;"> 
										...
										<tbody>
											...
											<tr class="commonStyle">
 											...
 											<tr class="commonStyle">
												<td style="background: white;" >是否过期</td>
							 		...
							 		<div  >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitAddEquipment">提交</button>
		...
		<!-- 添加证照-->
		<script src="<%=path%>/resources/js/addEquipment.js"></script>
