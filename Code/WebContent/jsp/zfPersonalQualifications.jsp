		  ...
		  <div class="am-form-group">
		    <div class="am-u-sm-8">
		      ...
		      <input type="hidden" id="f0601" name="f0601" value="${F0601 }" />
		   	...
		   	<div class="am-u-sm-4">
		      <button id="search" type="button" class="am-btn am-btn-block am-btn-secondary">搜索</button>
		    </div>
		  </div>
		</form>
	  </div>
...
<script src="<%=path%>/assets/js/zfPersonalQualifications.js"></script>
</body>
</html>