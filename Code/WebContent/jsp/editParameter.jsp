...
%>  
		...
		<div class="title"    style=" "  >
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						...
						<small style="font-size:22px;line-height:50px;" >修改参数</small>
					</li>
							...
							<div class="row">
								<div class="col-xs-12">
							 		...
							 		<div style="height: 100px;padding-top:50px;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitEditParameter">提交</button>
		...
		<!-- 编辑参数-->
		<script src="<%=path%>/resources/js/editParameter.js"></script>
