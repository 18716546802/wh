...
<%-- 		<base href="<%=basePath%>"></base> --%>
		...
		<style>
			#editCompanyTable,#hider{
				
				}
				#editCompanyTable span{
					font-size: 15px;
				}
		</style>
	...
	<body > 
				...
				<ul class="breadcrumb"  style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:22px;line-height:50px;">企业用户列表</small>
						</li>
					<li class="active" style="font-size:22px;color:#438eb9;">修改企业用户</li>
							...
							<div class="row">
								<div class="col-xs-12">
							 		<form  action="" method="post" runat="server"> 
										<table id="editCompanyTable" class="table table-striped table-bordered table-hover">									
											<tbody>
												
												
												<tr class="commonStyle">
													<td style="background: white;"><span style="color: red">*</span>用户登录密码</td>
												...
												<tr class="commonStyle">
													...
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0205" readonly="readonly"></td>
												...
												<tr class="commonStyle">
													...
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0207"></td>
												</tr>
											 
												<tr class="commonStyle">
													<td style="width: 25%;background: white;">联系电话2</td>
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0208"></td>
												</tr>
											</tbody>
							 		...
							 		<div style="height: 50px;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitFormCompanyUser">提交</button>
		...
		<!-- common js -->
		<script src="<%=path%>/resources/js/editCompanyUser.js"></script>
