				...
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:20px;line-height:50px;">用户列表</small>
						</li>
...
-->
		...
		<style>
			#jqgh_grid-table_f0202,#jqgh_grid-table_f0203,#jqgh_grid-table_f0204,#jqgh_grid-table_f0206,#jqgh_grid-table_f0207,
			#jqgh_grid-table_f0208,#jqgh_grid-table_f0205{
				text-align: center;
			}
		</style>
		<script src="<%=path%>/resources/js/WhUser.js"></script>
