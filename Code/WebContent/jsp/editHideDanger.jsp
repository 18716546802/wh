...
%>  
		...
		<div class="title"    style=" "  >
				<ul class="breadcrumb"   style="height:50px;">
					...
					<li class="active" style="font-size:22px;color:#438eb9;">修改隐患</li>
								...
								<div class="col-xs-12">
									...
									<tbody>
											...
											<tr class="commonStyle"  >
												...
												<td style="background: white;width: 25%;"><input id="f0803" type="text" style="width: 80%;" id="f0402" ></td>	
											...
											<tr class="commonStyle">
												...
												<td style="background: white;"><input id="f0805" type="text" style="width: 80%;"  id="f0404"></td>	 
						                        <td style="background: white;">复查人员</td>
												<td style="background: white;"><input id="f0806" type="text" style="width: 80%;"  id="f0404"></td>	 
											</tr>
											...
											<tr class="commonStyle">
												...
												<td style="background: white;"><input id="f0808" type="text" style="width: 80%;"  id="f0404"></td>
											...
											<tr class="commonStyle">
												...
												<td style="background: white;"><input id="f0810" type="text" style="width: 80%;"  id="f0404"></td>	 
										...
										<tbody>
											...
											<tr class="commonStyle">
												<td style="background: white;height: 200px;vertical-align: middle;text-align: center;"id="addPic">												
														...
														<button  type="button" class="btn btn-primary " >点击修改隐患图片</button>
								 		...
								 		<div style="height: 100px;" >
						 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitEditHideDanger">提交</button>
		...
		<!-- 修改隐患-->
		<script src="<%=path%>/resources/js/editHideDanger.js"></script>
