...
<%-- 		<base href="<%=basePath%>"></base> --%>
	...
	<body > 
				...
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:22px;line-height:50px;">万汇用户列表</small>
						</li>
					<li class="active" style="font-size:22px;color:#438eb9;">添加万汇用户</li>
							...
							<div class="row">
								<div class="col-xs-12">
							 		<form  action="" method="post" > 
										<table id="addUserTable" class="table table-striped table-bordered table-hover">									
											<tbody>
												...
												<tr class="commonStyle">
													...
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0205" value="万汇" readonly="readonly"></td>
							 		...
							 		<div style="height: 50px;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitFormAddWhUser">提交</button>
		...
		<!-- common js -->
		<script src="<%=path%>/resources/js/addUser.js"></script>
