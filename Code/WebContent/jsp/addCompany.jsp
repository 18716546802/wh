...
<%-- 		<base href="<%=basePath%>"></base> --%>
	...
	<body > 
    	...
    	<div class="main-content">
			<div class="title"    >
				<ul class="breadcrumb" style="height:50px;">
					...
					<li class="active" style="font-size:22px;color:#438eb9;">添加企业用户</li>
							...
							<div class="row">
								<div class="col-xs-12">
										...
										<table id="addCompanyTable" class="table table-striped table-bordered table-hover">									
											<tbody style="background: 100%;">
												...
												<tr class="commonStyle">
													<td style="background: white;width: 25%;"><span style="color: red">*</span>登陆账号</td>
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0202"></td> 
													
												</tr>
										 
												<tr class="commonStyle">
													<td style="background: white;width: 25%;"><span style="color: red">*</span>用户登陆密码</td>
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0203"></td>											 
													
												</tr>
											
												<tr class="commonStyle">
													<td style="background: white;width: 25%;"><span style="color: red">*</span>用户真实姓名</td>
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0204"></td>
													
												</tr>
												
												<tr class="commonStyle">
													<td style="background: white;width: 25%;">用户类型</td>
													<td style="background: white;"><input type="text" style="width: 80%;text-align:center;" id="f0205" value="企业" readonly="readonly"></td>
													
												</tr>
											
												<tr class="commonStyle">
													<td style="background: white;width: 25%;"><span style="color: red">*</span>是否是管理员</td>
							 		...
							 		<div style="height: 50px;" >
					 					<button  type="button" class="btn btn-large btn-primary " style="width: 45%;" id="submitFormAddCompanyUser">提交</button>
		...
		<script src="<%=path%>/resources/js/addCompanyUser.js"></script>
