...
%>  
			   	...
			   	<ul class="breadcrumb" style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:22px;line-height:50px;">企业信息</small>
						</li>
					<li class="active" style="font-size:22px;color:#438eb9;" id="companyName">企业基本信息</li>
			   </ul><!-- .breadcrumb -->			      
		...
		<!-- 企业链表-->
		<script src="<%=path%>/resources/js/companyList.js"></script>
