...
%>  
				...
				<ul class="breadcrumb"   style="height:50px;">
					<li >
						<i class="icon-home home-icon"></i>
							<small style="font-size:20px;line-height:50px;">人员资质</small>
						</li>
					<li class="active"  style="font-size:22px;color:#438eb9;" id="companyName"></li>
		...
		<!-- 人员 -->
 		<script src="<%=path%>/resources/js/companyPeople.js"></script>
