...
(function(b) {
	...
	b.extend(b.jgrid, {
		...
		parseDate: function(d, f, c, e) {
			...
			if(f && null != f)
				if(!isNaN(f - 0) && "u" === ("" + d).toLowerCase()) h = new Date(1E3 * parseFloat(f));
				else if(f.constructor === Date) h = f;
			else if(null !== j) h = new Date(parseInt(j[1], 10)), j[3] &&
		...
		from: function(d) {
			return new function(d, c) {
				...
				var e =
					...
					t = [],
					A = !0;
				if("object" === typeof d && d.push) 0 < d.length && (A = "object" !== typeof d[0] ? !1 : !0);
				...
				this.startsWith = function(a, d) {
					var c = null == d ? a : d,
						c = g ? b.trim(c.toString()).length : c.toString().length;
					...
					c = {
						...
						dragMove: function(a) {
							if(this.resizing) {
								...
								}), !0 === e.forceFit ? (d = this.headers[this.resizing.idx + e.nv], b = "ltr" === e.direction ? d.width - b : d.width + b, 33 < b && (a.newWidth =
					...
					if(this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
						...
						var o = function(a, b) {
							...
							n = function(d, e, g, f, h, i) {
								...
								if(e === 0) z = z + ("width: " + c.headers[d].width + "px;");
							...
							J = function(c, d, e, g, f) {
								...
								if(b.isXMLDoc(c)) {
									...
									var F = b(a),
										...
										E, q = {},
										x, D, r = [],
										K = a.p.altRows === true ? a.p.altclass : "",
										v;
									if(a.p.subGrid === true) {
										u = 1;
							...
							S = function(c, d, e, g, f) {
								...
								if(c) {
									...
									var k = b(a),
										l = 0,
										y, o, n, m = [],
										s = a.p.multiselect ? 1 : 0,
										u = a.p.subGrid === true ? 1 : 0,
										t, p = a.p.rownumbers === true ? 1 : 0,
										w = U(s + u + p);
									i = $(i);
									var v, E, q, x = {},
										D, r, K = [],
										B = a.p.altRows === true ? a.p.altclass : "",
										C;
							...
							ja = function() {
								...
								if(b.isArray(a.p.data)) {
									var o = a.p.grouping ? a.p.groupingView : false,
										n, m;
									...
									if(a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype,
										...
										if(a.p.grouping)
											for(m = 0; m < n; m++) s.orderBy(i[m], o.groupOrder[m], h[m].stype, h[m].srcfmt);
												...
												case "script":
													b.ajax(b.extend({
														...
														success: function(e, f, h) {
															if(b.isFunction(a.p.beforeProcessing) && a.p.beforeProcessing.call(a, e, f, h) === false) P();
															else {
							...
							la = function(c, d, e, g, f) {
								if(a.p.colModel[d].sortable) {
									...
									if(!(a.p.savedRow.length > 0)) {
										...
										if(b(a).triggerHandler("jqGridSortCol", [c, d, h]) === "stop") a.p.lastsort = d;
										else if(b.isFunction(a.p.onSortCol) && a.p.onSortCol.call(a, c, d, h) === "stop") a.p.lastsort = d;
										else {
						...
						(function() {
							var d = 0,
								e = b.jgrid.cell_width ? 0 : o(a.p.cellLayout,
									0),
								g = 0,
								f, h = o(a.p.scrollOffset, 0),
								i, k = false,
								l, m = 0,
								n;
							b.each(a.p.colModel, function() {
						...
						b(a).before(c.hDiv).click(function(c) {
							...
							if(!(v.tagName === "A" || (v.tagName === "INPUT" || v.tagName === "TEXTAREA" || v.tagName === "OPTION" || v.tagName === "SELECT") && !d) && e === true) {
								...
								if(a.p.cellEdit === true)
									if(a.p.multiselect && d) b(a).jqGrid("setSelection", w, true, c);
									else {
										w = p[0].rowIndex;
										try {
									...
									if(c[a.p.multikey]) b(a).jqGrid("setSelection", w, true, c);
									else {
	...
	b.jgrid.extend({
		...
		getDataIDs: function() {
			...
			this.each(function() {
				if((c = this.rows.length) && 0 < c)
					for(; f < c;) b(this.rows[f]).hasClass("jqgrow") && (d[e] = this.rows[f].id, e++), f++
			});
			return d
		},
		...
		getRowData: function(d) {
			...
			this.each(function() {
				var g = this,
					h, i;
				if(void 0 === d) e = !0, c = [], a = g.rows.length;
				else {
			...
			this.each(function() {
				...
				if(f) try {
					if(b(this.p.colModel).each(function(a) {
							...
							void 0 !==
								c && (l[e] = this.formatter && "string" === typeof this.formatter && "date" === this.formatter ? b.unformat.date.call(g, c, this) : c, h = g.formatter(d, c, a, f, "edit"), j = this.title ? {
									title: b.jgrid.stripHtml(h)
								} : {}, !0 === g.p.treeGrid && e === g.p.ExpandColumn ? b("td[role='gridcell']:eq(" + a + ") > span:first", i).html(h).attr(j) : b("td[role='gridcell']:eq(" + a + ")", i).html(h).attr(j))
						}), "local" === g.p.datatype) {
						var o = b.jgrid.stripPref(g.p.idPrefix, d),
							n = g.p._index[o],
							m;
						if(g.p.treeGrid)
							for(m in g.p.treeReader) g.p.treeReader.hasOwnProperty(m) &&
		...
		footerData: function(d, f, c) {
			...
			this.each(function() {
				...
				b(this.p.colModel).each(function(e) {
					a = this.name;
					"set" === d ? void 0 !== f[a] && (k = c ? i.formatter("", f[a], e, f, "edit") : f[a], h = this.title ? {
							title: b.jgrid.stripHtml(k)
						} : {}, b("tr.footrow td:eq(" + e + ")", i.grid.sDiv).html(k).attr(h),
		...
		setGridWidth: function(d, f) {
			return this.each(function() {
				if(this.grid) {
					var c = this,
						e, a = 0,
						j = b.jgrid.cell_width ? 0 : c.p.cellLayout,
						g, h = 0,
						i = !1,
						k = c.p.scrollOffset,
						l, o = 0,
		...
		setCell: function(d, f, c, e, a, j) {
			return this.each(function() {
				...
				if(this.grid && (isNaN(f) ? b(this.p.colModel).each(function(a) {
					...
					var k = b("td:eq(" + g + ")", h);
					if("" !== c || !0 === j) h = this.formatter(d, c, g, h, "edit"), i = this.p.colModel[g].title ? {
						title: b.jgrid.stripHtml(h)
					} : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i), "local" === this.p.datatype && (h = this.p.colModel[g], c = h.formatter && "string" === typeof h.formatter && "date" === h.formatter ?
			...
			return this.each(function() {
				...
				b(c).keydown(function(d) {
					var a = b(c).find("tr[tabindex=0]")[0],
						j, g, h, i = c.p.treeReader.expanded_field;
					if(a)
				...
				if(!this.ftoolbar) {
					var f = function() {
							...
							a.each(c.p.colModel, function() {
								...
								if((f = "custom" === this.stype && a.isFunction(this.searchoptions.custom_value) && 0 < i.length && "SPAN" === i[0].nodeName.toUpperCase() ? this.searchoptions.custom_value.call(c, i.children(".customelement:first"), "get") : i.val()) || "nu" === n || "nn" === n) e[l] = f, j[l] = n, d++;
								else try {
							...
							var g;
							c.p.searchurl && (g = c.p.url, a(c).jqGrid("setGridParam", {
								url: c.p.searchurl
							}));
					...
					a.each(c.p.colModel, function() {
						...
						g = "";
						var l = "=",
							s, n = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-" + c.p.direction + "'></th>"),
								...
								case "custom":
									...
									try {
										if(a.isFunction(d.custom_element)) {
											...
											if(u) u = a(u).addClass("customelement"), a(i).find(">span").append(u);
											else throw "e2";
										} else throw "e1";
									} catch(t) {
			...
			return this.each(function() {
				...
				for(c = 0; c < s; c++)
					if(e = n[c].el, d = a(e), f = l[c], h = {
							...
							role: "gridcell"
						}).css(h).addClass("ui-first-th-" + this.p.direction).appendTo(m), e.style.width = "", h = o(f.name, b.groupHeaders), 0 <= h) {
						h = b.groupHeaders[h];
						g = h.numberOfColumns;
						p = h.titleText;
						...
						j.append(e);
						g -= 1
					} else 0 === g ? b.useColSpanStyle ? d.attr("rowspan", "2") : (a("<th>", {
						role: "columnheader"
					}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({
						display: f.hidden ? "none" : "",
						"border-top": "0px none"
					...
					if(void 0 !== b.dataUrl) d = b.name ? ("" + b.id).substring(0, ("" + b.id).length - ("" + b.name).length - 1) : "" + b.id, g = b.postData || e.postData, i.p && i.p.idPrefix ? d = a.jgrid.stripPref(i.p.idPrefix, d) : g = void 0, a.ajax(a.extend({
						...
						success: function(d) {
							var b = [],
								...
								g = f.multiple === true,
								d = a.isFunction(f.buildSelect) ? f.buildSelect.call(i, d) : d;
							typeof d === "string" &&
								(d = a(a.trim(d)).html());
							if(d) {
								a(c).append(d);
		...
		searchGrid: function(b) {
			...
			return this.each(function() {
				...
				if(e.grid) {
					...
					if(void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
					else {
						...
						b.gbox = "#gbox_" + i;
						b.layer ? a.jgrid.createModal(u, m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
							position: "relative"
						}) : a.jgrid.createModal(u,
		...
		editGridRow: function(r, c) {
			...
			return this.each(function() {
				...
				function i(c, e, l, g) {
					...
					a(e.p.colModel).each(function(r) {
						...
						if("cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
							if(!1 === q) i = "";
							else if(h === e.p.ExpandColumn && !0 === e.p.treeGrid) i = a("td[role='gridcell']:eq(" + r + ")", e.rows[q]).text();
							else {
								try {
									i = a.unformat.call(e,
					...
					if("_empty" === c) a(m).each(function() {
						...
						o && (a('td[role="gridcell"]', o).each(function(j) {
							...
							if("cb" !== l && "subgrid" !== l && "rn" !== l && !0 === m[j].editable) {
								if(l === e.p.ExpandColumn && !0 === e.p.treeGrid) g = a(this).text();
								else try {
								...
								switch(m[j].edittype) {
									...
									case "checkbox":
										...
										if(m[j].editoptions && m[j].editoptions.value)
											if(m[j].editoptions.value.split(":")[0] === g) a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]({
												checked: !0,
												defaultChecked: !0
											});
											else a("#" +
				...
				function s() {
					...
					for(r in j)
						if(j.hasOwnProperty(r) && (l = a.jgrid.checkValues.call(d, j[r], r), !1 === l[0])) break;
					u();
					l[0] && (g = a(d).triggerHandler("jqGridAddEditClickSubmit", [b[d.p.id], j, v]), void 0 === g && a.isFunction(b[d.p.id].onclickSubmit) && (g = b[d.p.id].onclickSubmit.call(d, b[d.p.id], j, v) || {}), l = a(d).triggerHandler("jqGridAddEditBeforeSubmit", [j, a("#" + f), v]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[d.p.id].beforeSubmit) && (l = b[d.p.id].beforeSubmit.call(d, j, a("#" + f), v)));
							...
							complete: function(g,
								...
								if(l[0] === false) {
									...
									if(a.isFunction(b[d.p.id].afterComplete)) {
										e = g;
										setTimeout(function() {
											a(d).triggerHandler("jqGridAddEditAfterComplete", [e, j, a("#" + f), v]);
									...
									if(b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate) {
										...
										if(b[d.p.id]._savedData[d.p.id + "_id"] !== "_empty")
											for(n in b[d.p.id]._savedData) b[d.p.id]._savedData.hasOwnProperty(n) && j[n] && (b[d.p.id]._savedData[n] = j[n])
									}
								}
				...
				if(d.grid && r) {
					var q = d.p.id,
						...
						B = a.isFunction(b[d.p.id].onInitializeForm) ? b[d.p.id].onInitializeForm : !1,
						l = !0,
						z = 1,
						F = 0,
						j, K, v, f = a.jgrid.jqID(f);
					...
					if(void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
						...
						w[0].rp = 0;
						a(C).append(w);
						var l = (w = "rtl" === d.p.direction ? !0 : !1) ? "nData" : "pData",
							D = w ? "pData" : "nData";
						i(r, d, C, z);
			...
			return this.each(function() {
				...
				function i(b, d, e, g) {
					var f, h, i, k = 0,
						p, m, n = [],
						r = !1,
						o, q = "<td class='CaptionTD form-view-label ui-widget-content' width='" + c.labelswidth + "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
						s = "",
				...
				if(m.grid && r) {
					var h = m.p.id,
						g = "ViewGrid_" + a.jgrid.jqID(h),
						n = "ViewTbl_" + a.jgrid.jqID(h),
						x = "ViewGrid_" +
						h,
						d = "ViewTbl_" + h,
						q = {
						...
						f = a.isFunction(b[m.p.id].beforeInitData) ? b[m.p.id].beforeInitData : !1,
						o = !0,
						k = 1,
						p = 0;
			...
			return this.each(function() {
				...
				if(e.grid && r) {
					var i = a.isFunction(b[e.p.id].beforeShowForm),
						...
						u = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1,
						s = e.p.id,
						m = {},
						h = !0,
						g = "DelTbl_" + a.jgrid.jqID(s),
						n, x, d, q, f = "DelTbl_" + s,
						o = {
							themodal: "delmod" + s,
							modalhead: "delhd" +
										...
										if(f[0] === false) {
											...
											if(b[e.p.id].reloadAfterSubmit && e.p.datatype !== "local") a(e).trigger("reloadGrid");
												...
												if(e.p.treeGrid === true) try {
													...
													for(k = 0; k < i.length; k++) a(e).jqGrid("delRowData", e.p.idPrefix + i[k]);
												e.p.selrow = null;
												e.p.selarrrow = []
											}
					...
					if(h.grid && "string" === typeof b) {
						...
						for(x = 0; x < n; x++) {
							...
							c.edit &&
								(g = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", f).append(g), a(g, f).attr({
									...
									if(!a(this).hasClass("ui-state-disabled")) {
										var b = h.p.selrow;
										if(b) a.isFunction(c.editfunc) ? c.editfunc.call(h, b) : a(h).jqGrid("editGridRow", b, e);
										else {
							...
							c.view && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", f).append(g), a(g, f).attr({
								...
								if(!a(this).hasClass("ui-state-disabled")) {
									var b = h.p.selrow;
									if(b) a.isFunction(c.viewfunc) ? c.viewfunc.call(h, b) : a(h).jqGrid("viewGridRow", b, s);
									else {
										a.jgrid.viewModal("#" + m.themodal, {
											gbox: "#gbox_" + a.jgrid.jqID(h.p.id),
											jqm: true
		...
		GridToForm: function(b, c) {
			return this.each(function() {
				...
				if(e.grid) {
					...
					if(t)
						for(i in t) t.hasOwnProperty(i) && (a("[name=" + a.jgrid.jqID(i) + "]", c).is("input:radio") || a("[name=" + a.jgrid.jqID(i) + "]", c).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(i) + "]", c).each(function() {
							if(a(this).val() == t[i]) a(this)[e.p.useProp ? "prop" : "attr"]("checked", !0);
					...
					this.toString = function() {
						function a(b) {
							var c = "(",
								f;
							if(void 0 !== b.groups)
								for(f = 0; f < b.groups.length; f++) 1 < c.length && (c = "OR" === b.groupOp ? c + " || " : c + " && "), c += a(b.groups[f]);
							if(void 0 !==
								b.rules)
...
(function(a) {
	...
	a.jgrid.extend({
		editRow: function(c, b, e, o, l, g, n, h, f) {
			...
			else if(void 0 !== b && (j.keys = b), a.isFunction(e) && (j.oneditfunc = e), a.isFunction(o) && (j.successfunc = o), void 0 !== l && (j.url = l), void 0 !== g && (j.extraparam = g), a.isFunction(n) && (j.aftersavefunc = n), a.isFunction(h) && (j.errorfunc = h), a.isFunction(f)) j.afterrestorefunc = f;
			j = a.extend(!0, {
				keys: !1,
				oneditfunc: null,
				successfunc: null,
		...
		saveRow: function(c, b, e, o, l, g, n) {
			...
			if("1" === h) {
				...
				if("clientArray" === f.url) {
					...
					url: f.url,
					data: a.isFunction(d.p.serializeRowData) ? d.p.serializeRowData.call(d,
						r) : r,
					type: f.mtype,
					async: !1,
		...
		addRow: function(c) {
			...
			return this.each(function() {
				if(this.grid) {
					...
					if(c.useFormatter) a("#" + a.jgrid.jqID(c.rowID) + " .ui-inline-edit", "#" + a.jgrid.jqID(b.p.id)).click();
					else {
						var e = b.p.prmNames;
...
(function(d) {
	d.extend(d.jgrid, {
		template: function(b) {
			var g = d.makeArray(arguments).slice(1),
				f, a = g.length;
			null == b && (b = "");
		...
		groupingRender: function(b, g) {
			return this.each(function() {
				...
				var a = this,
					...
					h = "",
					c = "",
					k, l, j = e.groupCollapse ? e.plusicon : e.minusicon,
					m, q = [],
				...
				d.each(e.groups, function(s, i) {
					...
					if(w - 1 === i.idx) {
						var o = e.groups[s + 1],
							p, n, B = void 0 !== o ? e.groups[s + 1].startRow : b.length;
		...
		getNodeChildren: function(b) {
			...
			this.each(function() {
				...
				if(a.grid && a.p.treeGrid) switch(a.p.treeGridModel) {
					...
					case "adjacency":
						var k =
							a.p.treeReader.parent_id_field,
							m = a.p.localReader.id;
						d(this.p.data).each(function() {
