...
$(document).ready(function() {
	...
	var rowData = JSON.parse(localStorage.getItem("rowData"));
	 ...
	 f0401=rowData.f0401;
	 $("#f0402").val(rowData.f0402);
     $("#f0403").val(rowData.f0403);
	 $("#f0404").val(rowData.f0404);
	 $("#f0405").val(rowData.f0405);
	 $("#f0406").val(rowData.f0406);
	 $("#f0407").val(rowData.f0407);
	 $("#f0408").val(rowData.f0408);
	...
	$("#submitEquipDocument").click(function(){
		if(checkValue()){
			$.ajax({			
				type:"POST",
				url:"/WH/lowcard/updateCheckInfo",
				data:{
					f0301:f0301,
					f0401:f0401,
					f0402:f0402,
