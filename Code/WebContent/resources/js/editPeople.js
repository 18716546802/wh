...
$(document).ready(function(){
	   ...
	   f0101=rowData.f0101;
	   f0701=rowData.f0701;
	   $("#f0702").val(rowData.f0702);
	   $("#f0703").val(rowData.f0703);
	   $("#f0704").val(rowData.f0704);
	   $("#f0705").val(rowData.f0705);
	   $("#f0706").val(rowData.f0706);
	   $("#f0707").val(rowData.f0707);
	   $("#f0708").val(rowData.f0708);
	...
	$("#submitAddPeople").click(function(){
		...
		if(checkValue()){
			...
			$.ajax({
				type:"POST",
				url:"/WH/person/updataQualificationsByID",
				data:{
					f0701:f0701,
					f0101:f0101,
					f0702:f0702,
