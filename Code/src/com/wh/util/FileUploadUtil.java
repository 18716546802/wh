...
public class FileUploadUtil {
	 private static final int BUF_SIZE = 2 * 1024;  
	     ...
	     * @throws IOException 
	     */  
	    public static void upload1(Plupload plupload, File dir,String uuid) throws IllegalStateException, IOException {  
	        //生成唯一的文件名 
	    	
	        String filename = uuid + "."+ plupload.getName().split("\\.")[1];  
